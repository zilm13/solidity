...
BOOST_AUTO_TEST_CASE(format_unsigned_singleline)
{
	...
	BOOST_REQUIRE_EQUAL(test.format("", TestFunctionCall::RenderMode::ResultsOnly), "// f(uint8): 1 -> 2");
}
...
BOOST_AUTO_TEST_CASE(format_unsigned_singleline_signed_encoding)
{
	...
	BOOST_REQUIRE_EQUAL(test.format("", TestFunctionCall::RenderMode::ResultsOnly), "// f(uint8): 1 -> -1");
}
...
BOOST_AUTO_TEST_CASE(format_signed_singleline)
{
	...
	BOOST_REQUIRE_EQUAL(test.format("", TestFunctionCall::RenderMode::ResultsOnly), "// f(int8): -1 -> -2");
}
...
BOOST_AUTO_TEST_CASE(format_hex_singleline)
{
	...
	BOOST_REQUIRE_EQUAL(test.format("", TestFunctionCall::RenderMode::ResultsOnly), "// f(bytes32): 0x31 -> 0x32");
}
...
BOOST_AUTO_TEST_CASE(format_bool_true_singleline)
{
	...
	BOOST_REQUIRE_EQUAL(test.format("", TestFunctionCall::RenderMode::ResultsOnly), "// f(bool): true -> false");
}

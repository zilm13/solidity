...
class RedundantStoreEliminator: public DataFlowAnalyzer
		// TODO maybe we can make this work wihtout data flow analyzer.
		// the problem is that we need to keep track if there were any
		// other writes to storage in between
{
public:
